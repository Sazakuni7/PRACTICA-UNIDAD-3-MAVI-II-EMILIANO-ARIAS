...
public:
    ...
    Caja(b2World* _world, RenderWindow* _wnd)
    {
        ...
        fixtureDef.density = 1.f; // Densidad del cuerpo físico
        fixtureDef.friction = 1.0f; // Fricción del cuerpo físico
        fixtureDef.restitution = 0.3f; // Restitución (elasticidad) del cuerpo físico
...
int main(int argc, char* argv[])
{
    ...
    Juego = new Game(800, 600, "Caja movible - MAVI II");
